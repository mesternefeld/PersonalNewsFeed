  ...
  $json = json_decode($file, true);
    foreach ($json as $value) {
        ...
        if (in_array($_POST['user_name'], $value)) {
            if (in_array($_POST['password'], $value)) {
    ...
    <section>
        ...
        <div class="container">
            ...
            <div class="field-group">
              <div><label for="login">User-name</label></div>
            ...
            <div class="field-group">
              <div><input type="submit" name="login" value="login" class="form-submit-button  btn btn-primary btn-sm rounded-pill mt-5"></span></div>
            </div>       
          </form>
          <br /><a href="./newAccount.php" class="btn btn-primary btn-sm rounded-pill">Don't have an account?</a>
          </div>
          <br />
    </section>
